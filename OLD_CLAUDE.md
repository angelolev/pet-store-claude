...
The app is a small client-only pet store SPA. All product data is hard-coded; there is no backend or persistence.
...
- UI copy and route paths are in Spanish (`/productos`, `/carrito`). Keep new user-facing strings and routes in Spanish to match.
